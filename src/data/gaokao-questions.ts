  ...
  "sets-logic": [
    {
      ...
      source: "gaokao",
      prompt: "若集合$M=\\{x\\mid \\sqrt{x}<4\\}$，$N=\\{x\\mid 3x\\ge1\\}$，则$M\\cap N=$____",
      type: "fill",
      difficulty: 1,
    ...
    },
    {
      ...
      chapterId: "sets-logic",
      source: "gaokao",
      prompt: "已知集合$A=\\{-1,1,2,4\\}$，$B=\\{x\\mid |x-1|\\le1\\}$，则$A\\cap B=$____",
      type: "fill",
      difficulty: 1,
    ...
    },
    {
      ...
      chapterId: "sets-logic",
      source: "gaokao",
      prompt: "已知集合$M=\\{-2,-1,0,1,2\\}$，$N=\\{x\\mid x^2-x-6\\ge0\\}$，则$M\\cap N=$____",
      type: "fill",
      difficulty: 1,
    ...
    },
    {
      ...
      chapterId: "sets-logic",
      source: "gaokao",
      prompt: "记$S_n$为数列$\\{a_n\\}$的前$n$项和，设甲：$\\{a_n\\}$为等差数列；乙：$\\left\\{\\dfrac{S_n}{n}\\right\\}$为等差数列，则____",
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "sets-logic",
      source: "gaokao",
      prompt: "已知集合$A=\\{x\\mid -5<x^3<5\\}$，$B=\\{-3,-1,0,2,3\\}$，则$A\\cap B=$____",
      type: "fill",
      difficulty: 1,
    ...
    },
    {
      ...
      chapterId: "sets-logic",
      source: "gaokao",
      prompt: "已知命题$p$：$\\forall x\\in\\mathbb{R},\\ |x+1|>1$；命题$q$：$\\exists x>0,\\ x^3=x$，则____",
      type: "fill",
      difficulty: 1,
    ...
    },
    {
      ...
      chapterId: "sets-logic",
      source: "gaokao",
      prompt: "设全集$U=\\{x\\mid x$是小于9的正整数$\\}$，集合$A=\\{1,3,5\\}$，则$\\complement_U A$元素个数为____",
      type: "fill",
      difficulty: 1,
    ...
    },
    {
      ...
      chapterId: "sets-logic",
      source: "gaokao",
      prompt: "已知集合$A=\\{-4,0,1,2,8\\}$，$B=\\{x\\mid x^3=x\\}$，则$A\\cap B=$____",
      type: "fill",
      difficulty: 1,
    ...
    },
    {
      ...
      chapterId: "sets-logic",
      source: "gaokao",
      prompt: "已知集合$A=\\left\\{\\sin\\dfrac{7\\pi}{6},\\cos\\dfrac{5\\pi}{3},\\tan\\dfrac{5\\pi}{4}\\right\\}$，$B=\\left\\{-\\dfrac{\\sqrt{3}}{2},-\\dfrac{1}{2},1\\right\\}$，则$A\\cap B=$____。",
      type: "fill",
      difficulty: 1,
    ...
    },
    {
      ...
      chapterId: "sets-logic",
      source: "gaokao",
      prompt: `已知集合$A=\\{0,1,3,6,9\\}$，$B=\\{x\\mid\\sqrt{x}=x\\}$，则$A\\cap B=$____。`,
      type: "fill",
      difficulty: 1,
  ...
  "quadratic-ineq": [
    {
      ...
      source: "gaokao",
      prompt: `若$x,y$满足$x^2+y^2-xy=1$，则____`,
      type: "fill",
      difficulty: 3,
    ...
    },
    {
      ...
      chapterId: "quadratic-ineq",
      source: "gaokao",
      prompt: "不等式$\\dfrac{x-4}{x-1}\\ge2$的解集是____",
      type: "fill",
      difficulty: 1,
  ...
  "func-concept": [
    {
      ...
      source: "gaokao",
      prompt: "已知函数$f(x)$的定义域为$\\mathbb{R}$，且$f(x+y)+f(x-y)=f(x)f(y),f(1)=1$，则$\\sum\\limits_{k=1}^{22}f(k)=$____",
      type: "fill",
      difficulty: 3,
    ...
    },
    {
      ...
      chapterId: "func-concept",
      source: "gaokao",
      prompt: `已知函数$f(x)$定义域为$\\mathbb{R}$，满足$f(xy)=y^2f(x)+x^2f(y)$，则____`,
      type: "fill",
      difficulty: 3,
    ...
    },
    {
      ...
      chapterId: "func-concept",
      source: "gaokao",
      prompt: "已知函数$f(x)=\\begin{cases}-x^2-2ax-a,&x<0\\\\e^x+\\ln(x+1),&x\\ge0\\end{cases}$，在$\\mathbb{R}$上单调递增，则$a$取值的范围是____",
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "func-concept",
      source: "gaokao",
      prompt: "已知函数$f(x)$的定义域为$\\mathbb{R}$，$f(x)>f(x-1)+f(x-2)$，且当$x<3$时$f(x)=x$，则下列结论中一定正确的是____",
      type: "fill",
      difficulty: 3,
    ...
    },
    {
      ...
      chapterId: "func-concept",
      source: "gaokao",
      prompt: "设函数$f(x)=a(x+1)^2-1$，$g(x)=\\cos x+2ax$，当$x\\in(-1,1)$时，曲线$y=f(x)$与$y=g(x)$恰有一个交点，则$a=$____",
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "func-concept",
      source: "gaokao",
      prompt: "设$f(x)$是定义在$\\mathbb{R}$上且周期为2的偶函数，当$2\\le x\\le3$时，$f(x)=5-2x$，则$f\\left(-\\dfrac{3}{4}\\right)=$____",
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "func-concept",
      source: "gaokao",
      prompt: `已知$f(x)$是定义在$\\mathbb{R}$上的奇函数，且当$x>0$时，$f(x)=(x^2-3)e^x+2$，则____`,
      type: "fill",
      difficulty: 3,
    ...
    },
    {
      ...
      chapterId: "func-concept",
      source: "gaokao",
      prompt: `已知函数$f(x)=\\dfrac{x+2}{e^x+a}$的最大值为$1$，则$a=$____。`,
      type: "fill",
      difficulty: 2,
...
详细：由$f(0)\ge1$，且当$x<0$时$f(x)<1$，所以$f(0)>f(x)$对任意$x<0$成立。取$x_1<0$，则$f(x_1)<f(0)$，即$f(0)\ge f(x_1)$，由①得$D(x_1)\subseteq D(0)$。取$d$满足$0<d<1$，则$d\in D(x_1)$（因为$x_1<0$，$x_1+d<x_1$，递减得$f(x_1+d)>f(x_1)$），但由条件②，$f(d)<f(0)$，所以$d\notin D(0)$，矛盾。因此假设$f$在正半轴不单调递增导致矛盾，故$f$在$(0,+\infty)$上单调递增。`,
    ...
    },
    {
      ...
      chapterId: "func-concept",
      source: "gaokao",
      prompt: `已知$f(x)$为定义在$\\mathbb{R}$上的偶函数，且$f(x)+f(x-2)=0$，当$x\\in\\left[\\dfrac32,3\\right]$时，$f(x)=x^2+ax+b$，则____。`,
      type: "fill",
      difficulty: 2,
  ...
  "exp-log": [
    {
      ...
      chapterId: "exp-log",
      source: "gaokao",
      prompt: "设$a=0.1e^{0.1}$，$b=\\dfrac19$，$c=-\\ln0.9$，则____",
      type: "fill",
      difficulty: 3,
    ...
    },
    {
      ...
      chapterId: "exp-log",
      source: "gaokao",
      prompt: "设函数$f(x)=2^{x(x-a)}$在区间$(0,1)$上单调递减，则$a$的取值范围是____",
      type: "fill",
      difficulty: 2,
...
|混合动力汽车|10|$50\\sim60$|
|电动汽车|10|$40$|
已知距离三类车10m处实际声压为$p_1,p_2,p_3$，则____`,
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "exp-log",
      source: "gaokao",
      prompt: "若实数$x,y,z$满足$2+\\log_2 x=3+\\log_3 y=5+\\log_5 z$，则$x,y,z$的大小关系不可能是____",
      type: "fill",
      difficulty: 3,
  ...
  "trigonometric": [
    {
      ...
      source: "gaokao",
      prompt: "记函数$f(x)=\\sin(\\omega x+\\dfrac{\\pi}{4})+b(\\omega>0)$最小正周期为$T$。若$\\dfrac{2\\pi}{3}<T<\\pi$，且$y=f(x)$的图象关于点$(\\dfrac{3\\pi}{2},2)$中心对称，则$f(\\dfrac{\\pi}{2})=$____",
      type: "fill",
      difficulty: 2,
...
(2) 求$\\dfrac{a^2+b^2}{c^2}$的最小值.`,
    ...
    },
    {
      ...
      chapterId: "trigonometric",
      source: "gaokao",
      prompt: "若$\\sin(\\alpha+\\beta)+\\cos(\\alpha+\\beta)=2\\sqrt{2}\\cos\\left(\\alpha+\\dfrac{\\pi}{4}\\right)\\sin\\beta$，则____",
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "trigonometric",
      source: "gaokao",
      prompt: `已知函数$f(x)=\\sin(2x+\\varphi)(0<\\varphi<\\pi)$的图像关于点$\\left(\\dfrac{2\\pi}{3},0\\right)$中心对称，则____`,
      type: "fill",
      difficulty: 2,
...
所以$b=2R\sin B=2\cdot\dfrac34\cdot\dfrac13=\dfrac12$.`,
    ...
    },
    {
      ...
      chapterId: "trigonometric",
      source: "gaokao",
      prompt: "已知$\\sin(\\alpha-\\beta)=\\dfrac13$，$\\cos\\alpha\\sin\\beta=\\dfrac16$，则$\\cos(2\\alpha+2\\beta)=$____",
      type: "fill",
      difficulty: 3,
...
(2) 设$AB=5$，求$AB$边上的高.`,
    ...
    },
    {
      ...
      chapterId: "trigonometric",
      source: "gaokao",
      prompt: "已知$\\cos(\\alpha+\\beta)=m$，$\\tan\\alpha\\tan\\beta=2$，则$\\cos(\\alpha-\\beta)=$____",
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "trigonometric",
      source: "gaokao",
      prompt: "当$x\\in[0,2\\pi]$时，曲线$y=\\sin x$与$y=2\\sin\\left(3x-\\dfrac{\\pi}{6}\\right)$的交点个数为____",
      type: "fill",
      difficulty: 2,
...
由$S=3+\sqrt{3}$得$R^2\cdot\frac{3+\sqrt{3}}{4}=3+\sqrt{3}$，所以$R^2=4$，$R=2$，故$c=\sqrt{2}R=2\sqrt{2}$。`,
    ...
    },
    {
      ...
      chapterId: "trigonometric",
      source: "gaokao",
      prompt: `对于函数$f(x)=\\sin2x$和$g(x)=\\sin\\left(2x-\\dfrac{\\pi}{4}\\right)$，下列正确的有____`,
      type: "fill",
      difficulty: 2,
...
(2) 若$a=2$，$\\sqrt{2}b\\sin C=c\\sin2B$，求$\\triangle ABC$的周长.`,
    ...
    },
    {
      ...
      chapterId: "trigonometric",
      source: "gaokao",
      prompt: "若点$(a,0)(a>0)$是函数$y=2\\tan\\left(x-\\dfrac{\\pi}{3}\\right)$的图象的一个对称中心，则$a$的最小值为____",
      type: "fill",
      difficulty: 1,
    ...
    },
    {
      ...
      chapterId: "trigonometric",
      source: "gaokao",
      prompt: `已知$\\triangle ABC$的面积为$\\dfrac14$，若$\\cos2A+\\cos2B+2\\sin C=2$，$\\cos A\\cos B\\sin C=\\dfrac14$，则____`,
      type: "fill",
      difficulty: 3,
    ...
    },
    {
      ...
      chapterId: "trigonometric",
      source: "gaokao",
      prompt: "在$\\triangle ABC$中，$BC=2$，$AC=1+\\sqrt{3}$，$AB=\\sqrt{6}$，则$A=$____",
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "trigonometric",
      source: "gaokao",
      prompt: "已知$0<\\alpha<\\pi$，$\\cos\\dfrac{\\alpha}{2}=\\dfrac{\\sqrt{5}}{5}$，则$\\sin\\left(\\alpha-\\dfrac{\\pi}{4}\\right)=$____",
      type: "fill",
      difficulty: 2,
...
(2) 设$D,E$两点满足：$D$在$BA$的延长线上，$DE\\parallel BC$，$AE\\perp AC$.若$DE=\\sqrt{6}$，求$CE$.`,
    ...
    },
    {
      ...
      chapterId: "trigonometric",
      source: "gaokao",
      prompt: `已知$\\alpha$为第二象限角，且$3\\sin2\\alpha\\cos\\alpha=8\\sin\\alpha\\cos2\\alpha$，则$\\dfrac{1+\\sin\\alpha}{2-\\cos\\alpha}=$____。`,
      type: "fill",
      difficulty: 2,
  ...
  "vectors-app": [
    {
      ...
      source: "gaokao",
      prompt: "在$\\triangle ABC$中，点$D$在边$AB$上，$BD=2DA$。记$\\overrightarrow{CA}=\\boldsymbol{m}$，$\\overrightarrow{CD}=\\boldsymbol{n}$，则$\\overrightarrow{CB}=$____",
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "vectors-app",
      source: "gaokao",
      prompt: "已知向量$\\boldsymbol{a}=(3,4),\\boldsymbol{b}=(1,0),\\boldsymbol{c}=\\boldsymbol{a}+t\\boldsymbol{b}$，若$\\langle \\boldsymbol{a},\\boldsymbol{c}\\rangle=\\langle \\boldsymbol{b},\\boldsymbol{c}\\rangle$，则$t=$____",
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "vectors-app",
      source: "gaokao",
      prompt: "已知向量$\\boldsymbol{a}=(1,1)$，$\\boldsymbol{b}=(1,-1)$，若$(\\boldsymbol{a}+\\lambda\\boldsymbol{b})\\perp(\\boldsymbol{a}+\\mu\\boldsymbol{b})$，则____",
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "vectors-app",
      source: "gaokao",
      prompt: "已知向量$\\boldsymbol{a}=(0,1)$，$\\boldsymbol{b}=(2,x)$，若$\\boldsymbol{b}\\perp (\\boldsymbol{b}-4\\boldsymbol{a})$，则$x=$____",
      type: "fill",
      difficulty: 1,
    ...
    },
    {
      ...
      chapterId: "vectors-app",
      source: "gaokao",
      prompt: "已知向量$\\boldsymbol{a},\\boldsymbol{b}$满足$|\\boldsymbol{a}|=1,\\ |\\boldsymbol{a}+2\\boldsymbol{b}|=2$，且$(\\boldsymbol{b}-2\\boldsymbol{a})\\perp \\boldsymbol{b}$，则$|\\boldsymbol{b}|=$____",
      type: "fill",
      difficulty: 2,
...
已知测得视风风速向量、船速向量如图，风速大小与向量模长相等，单位$\\mathrm{m/s}$，则真风为____`,
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "vectors-app",
      source: "gaokao",
      prompt: `已知平面向量$\\boldsymbol{a},\\boldsymbol{b}$不共线，且$2\\boldsymbol{a}+y\\boldsymbol{b}=x\\boldsymbol{a}-3\\boldsymbol{b}$，则____。`,
      type: "fill",
      difficulty: 1,
    ...
    },
    {
      ...
      chapterId: "vectors-app",
      source: "gaokao",
      prompt: `已知向量$\\boldsymbol{a},\\boldsymbol{b}$满足$|\\boldsymbol{a}+\\boldsymbol{b}|=1$，$|\\boldsymbol{a}-\\boldsymbol{b}|=\\sqrt{3}$，则$\\boldsymbol{a}\\cdot\\boldsymbol{b}=$____。`,
      type: "fill",
      difficulty: 1,
  ...
  "complex": [
    {
      ...
      chapterId: "complex",
      source: "gaokao",
      prompt: "若$\\mathrm{i}(1-z)=2$，则$\\overline{z}=$____",
      type: "fill",
      difficulty: 1,
    ...
    },
    {
      ...
      chapterId: "complex",
      source: "gaokao",
      prompt: "$(2+2\\mathrm{i})(1-2\\mathrm{i})=$____",
      type: "fill",
      difficulty: 1,
    ...
    },
    {
      ...
      chapterId: "complex",
      source: "gaokao",
      prompt: "已知$z=\\dfrac{1-\\mathrm{i}}{2+2\\mathrm{i}}$，则$z-\\overline{z}=$____",
      type: "fill",
      difficulty: 1,
    ...
    },
    {
      ...
      chapterId: "complex",
      source: "gaokao",
      prompt: "若$\\dfrac{z}{z-1}=1+\\mathrm{i}$，则$z=$____",
      type: "fill",
      difficulty: 1,
    ...
    },
    {
      ...
      chapterId: "complex",
      source: "gaokao",
      prompt: "已知$z=-1-\\mathrm{i}$，则$|z|=$____",
      type: "fill",
      difficulty: 1,
    ...
    },
    {
      ...
      chapterId: "complex",
      source: "gaokao",
      prompt: "$(1+5\\mathrm{i})\\mathrm{i}$ 的虚部为____",
      type: "fill",
      difficulty: 1,
    ...
    },
    {
      ...
      chapterId: "complex",
      source: "gaokao",
      prompt: "已知$z=1+\\mathrm{i}$，则$\\dfrac{1}{z-1}=$____",
      type: "fill",
      difficulty: 1,
  ...
  "solid-geometry": [
    {
      ...
      source: "gaokao",
      prompt: "南水北调工程缓解了北方一些地区水资源短缺问题，其中一部分水蓄入某水库。已知该水库水位为海拔$148.5\\mathrm{m}$时，相应水面的面积为$140.0\\mathrm{km}^2$；水位为海拔$157.5\\mathrm{m}$时，相应水面的面积为$180.0\\mathrm{km}^2$，将该水库在这两个水位间的形状看作一个棱台，则该水库水位从海拔$148.5\\mathrm{m}$上升到$157.5\\mathrm{m}$时，增加的水量约为（$\\sqrt{7}\\approx2.65$）____。",
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "solid-geometry",
      source: "gaokao",
      prompt: "已知正四棱锥$S-ABCD$的侧棱长为$l$，其各顶点都在同一球面上。若该球的体积为$36\\pi$，且$3\\le l\\le3\\sqrt{3}$，则该正四棱锥体积的取值范围是____",
      type: "fill",
      difficulty: 3,
    ...
    },
    {
      ...
      chapterId: "solid-geometry",
      source: "gaokao",
      prompt: `已知正方体$ABCD-A_1B_1C_1D_1$，则____`,
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "solid-geometry",
      source: "gaokao",
      prompt: "已知正三棱台的高为$1$，上、下底面边长分别为$3\\sqrt{3}$和$4\\sqrt{3}$，其顶点都在同一球面上，则该球的表面积为____",
      type: "fill",
      difficulty: 3,
    ...
    },
    {
      ...
      chapterId: "solid-geometry",
      source: "gaokao",
      prompt: `如图，四边形$ABCD$为正方形，$ED\\perp$平面$ABCD$，$FB\\parallel ED$，$AB=ED=2FB$，记三棱锥$E-ACD$，$F-ABC$，$F-ACE$的体积分别为$V_1,V_2,V_3$，则____`,
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "solid-geometry",
      source: "gaokao",
      prompt: `下列物体能完整放入棱长$1\\mathrm{m}$正方体容器（壁厚忽略）的有____`,
      type: "fill",
      difficulty: 3,
    ...
    },
    {
      ...
      chapterId: "solid-geometry",
      source: "gaokao",
      prompt: "已知圆柱和圆锥的底面半径相等，侧面积相等，且它们的高均为$\\sqrt{3}$，则圆锥的体积为____",
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "solid-geometry",
      source: "gaokao",
      prompt: "已知正三棱台$ABC-A_1B_1C_1$的体积为$\\dfrac{52}{3}$，$AB=6$，$A_1B_1=2$，则$A_1A$与平面$ABC$所成角的正切值为____",
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "solid-geometry",
      source: "gaokao",
      prompt: `在正三棱柱$ABC-A_1B_1C_1$中，$D$为$BC$中点，则____`,
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "solid-geometry",
      source: "gaokao",
      prompt: `在空间中，$A、B$为两个定点，动点$C$到直线$AB$的距离为2，动点$D$到直线$AB$的距离为1，若二面角$C-AB-D$为$60^\\circ$，则____。`,
      type: "fill",
      difficulty: 3,
    ...
    },
    {
      ...
      chapterId: "solid-geometry",
      source: "gaokao",
      prompt: `棱台上下底面均为有一个内角是$60^\\circ$的菱形，上下底面边长分别为$2$和$3$，该棱台的高为$\\sqrt{3}$，则该棱台体积为____。`,
      type: "fill",
      difficulty: 2,
...
则$P(A|B)=\frac{P(AB)}{P(B)}=\frac{P(B|A)P(A)}{P(B)}=\frac{0.23\times0.001}{0.16}=0.0014375\approx0.0014$。`,
    ...
    },
    {
      ...
      chapterId: "statistics",
      source: "gaokao",
      prompt: `有一组样本数据$x_1,x_2,\\dots,x_6$，其中$x_1$是最小值，$x_6$是最大值，则____`,
      type: "fill",
      difficulty: 2,
...
据表中数据，结论中正确的是____`,
    ...
    },
    {
      ...
      chapterId: "statistics",
      source: "gaokao",
      prompt: "样本数据$2，8，14，16，20$的平均数为____",
      type: "fill",
      difficulty: 1,
    ...
    },
    {
      ...
      chapterId: "statistics",
      source: "gaokao",
      prompt: `样本数据$6,8,4,5,12$的中位数为____。`,
      type: "fill",
      difficulty: 1,
...
(ii) 工厂向某用户销售100件电子元件，$X$为这100件产品首次出现故障小于365天的件数，则$X\\sim B(100,\\hat{p})$，求$E(X),D(X)$.`,
  ...
  "probability": [
    {
      ...
      source: "gaokao",
      prompt: "从2至8的7个整数中随机取2个不同的数，则这2个数互质的概率为____",
      type: "fill",
      difficulty: 2,
  ...
  "lines-circles": [
    ...
    },
    {
      ...
      chapterId: "lines-circles",
      source: "gaokao",
      prompt: "过点$(0,-2)$与圆$x^2+y^2-4x-1=0$相切的两条直线的夹角为$\\alpha$，则$\\sin\\alpha=$____",
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "lines-circles",
      source: "gaokao",
      prompt: "若圆$x^2+(y+2)^2=r^2(r>0)$上到直线$y=\\sqrt{3}x+2$的距离为1的点有且仅有2个，则$r$的取值范围是____",
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "lines-circles",
      source: "gaokao",
      prompt: `已知圆$C_1:(x+1)^2+y^2=1$，圆$C_2:(x-1)^2+y^2=1$，圆$C_3:x^2+(y-\\sqrt{3})^2=1$，直线$l:y=kx+b$与$C_1,C_2,C_3$均有两个交点，记$l$被$C_1,C_2,C_3$截得的弦长分别为$s_1,s_2,s_3$，则____。`,
      type: "fill",
      difficulty: 3,
    ...
    },
    {
      ...
      chapterId: "lines-circles",
      source: "gaokao",
      prompt: `已知$\\odot O:x^2+y^2=1$，$\\odot A:x^2+y^2-6x-8y+k=0$，则____。`,
      type: "fill",
      difficulty: 2,
  ...
  "conic-sections": [
    {
      ...
      source: "gaokao",
      prompt: `已知$O$为坐标原点，点$A(1,2)$在抛物线$C:y^2=2px(p>0)$上，过点$B(0,1)$的直线交$C$于$P,Q$两点，则____`,
      type: "fill",
      difficulty: 3,
...
(2) 若$\\tan\\angle PAQ=2\\sqrt{2}$，求$\\triangle PAQ$的面积。`,
    ...
    },
    {
      ...
      chapterId: "conic-sections",
      source: "gaokao",
      prompt: `已知$O$为坐标原点，过抛物线$C:y^2=2px(p>0)$焦点$F$的直线与$C$交于$A,B$两点，其中$A$在第一象限，点$M(p,0)$，若$|AF|=|AM|$，则____`,
      type: "fill",
      difficulty: 3,
...
①$M$在$AB$上；②$PQ\\parallel AB$；③$|MA|=|MB|$.`,
    ...
    },
    {
      ...
      chapterId: "conic-sections",
      source: "gaokao",
      prompt: "设椭圆$C_1:\\dfrac{x^2}{a^2}+y^2=1(a>1)$，$C_2:\\dfrac{x^2}{4}+y^2=1$的离心率分别为$e_1,e_2$，若$e_2=\\sqrt{3}e_1$，则$a=$____",
      type: "fill",
      difficulty: 2,
...
(2) 矩形$ABCD$有三个顶点在$W$上，证明：矩形周长大于$3\\sqrt{3}$.`,
    ...
    },
    {
      ...
      chapterId: "conic-sections",
      source: "gaokao",
      prompt: `造型可以做成美丽的丝带，将其看作图中曲线$C$的一部分。已知$C$过坐标原点$O$，且$C$上的点满足横坐标大于$-2$，到点$F(2,0)$的距离与到定直线$x=a(a<0)$的距离之积为$4$，则____`,
      type: "fill",
      difficulty: 3,
...
(2) 若过$P$的直线$l$交$C$于另一点$B$，且$\\triangle ABP$的面积为$9$，求$l$的方程.`,
    ...
    },
    {
      ...
      chapterId: "conic-sections",
      source: "gaokao",
      prompt: "已知曲线$C:x^2+y^2=16\\ (y>0)$，从$C$上任意一点$P$向$x$轴作垂线段$PP'$，$P'$为垂足，则线段$PP'$的中点$M$的轨迹方程为____",
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "conic-sections",
      source: "gaokao",
      prompt: `抛物线$C:y^2=4x$的准线为$l$，$P$为$C$上的动点，过$P$作$\\odot A:x^2+(y-4)^2=1$的一条切线，$Q$为切点，过$P$作$l$的垂线，垂足为$B$，则____`,
      type: "fill",
      difficulty: 3,
...
(3) 设$S_n$为$\\triangle P_nP_{n+1}P_{n+2}$的面积，证明：对任意的正整数$n$，$S_n=S_{n+1}$.`,
    ...
    },
    {
      ...
      chapterId: "conic-sections",
      source: "gaokao",
      prompt: "若双曲线$C$的虚轴长为实轴长的$\\sqrt{7}$倍，则$C$的离心率为____",
      type: "fill",
      difficulty: 1,
    ...
    },
    {
      ...
      chapterId: "conic-sections",
      source: "gaokao",
      prompt: `设抛物线$C:y^2=6x$的焦点为$F$，过$F$的直线交$C$于$A、B$，过$F$且垂直于$AB$的直线交准线$l:x=-\\dfrac32$于$E$，过点$A$作准线$l$的垂线，垂足为$D$，则____`,
      type: "fill",
      difficulty: 2,
...
(ii) $O$为坐标原点，$M$是椭圆上动点，直线$OR$的斜率为直线$OP$斜率的3倍，求$|PM|$的最大值。`,
    ...
    },
    {
      ...
      chapterId: "conic-sections",
      source: "gaokao",
      prompt: "设抛物线$C:y^2=2px(p>0)$的焦点为$F$，点$A$在$C$上，过$A$作$C$的准线的垂线，垂足为$B$，若直线$BF$的方程为$y=-2x+2$，则$|AF|=$____",
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "conic-sections",
      source: "gaokao",
      prompt: `双曲线$C:\\dfrac{x^2}{a^2}-\\dfrac{y^2}{b^2}=1(a>0,b>0)$的左、右焦点分别是$F_1、F_2$，左、右顶点分别为$A_1，A_2$，以$F_1F_2$为直径的圆与$C$的一条渐近线交于$M、N$两点，且$\\angle NA_1M=\\dfrac{5\\pi}{6}$，则____`,
      type: "fill",
      difficulty: 3,
...
(2) 过点$(0,-2)$的直线$l$与$C$交于$A,B$两点，$O$为坐标原点，若$\\triangle OAB$的面积为$\\sqrt{2}$，求$|AB|$.`,
    ...
    },
    {
      ...
      chapterId: "conic-sections",
      source: "gaokao",
      prompt: `已知抛物线$C_1:y^2=2p_1x(p_1>0)$和$C_2:x^2=2p_2y(p_2>0)$均经过点$(4,8)$，则$C_1$的焦点与$C_2$的焦点之间的距离为____。`,
      type: "fill",
      difficulty: 2,
...
(ii) 求$\\tan\\angle PQR$的最小值.`,
    ...
    },
    {
      ...
      chapterId: "conic-sections",
      source: "gaokao",
      prompt: `双曲线$C:\\dfrac{x^2}{a^2}-\\dfrac{y^2}{b^2}=1(a>0,b>0)$过点$(1,0)$和$\\left(\\dfrac{\\sqrt{5}}{2},3\\right)$，则其渐近线方程为____。`,
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "conic-sections",
      source: "gaokao",
      prompt: `已知抛物线$E:y^2=8x$，斜率$k(k>0)$的直线$l$过点$(1,0)$，$\\triangle ABC$为等边三角形，$A$在$y$轴上，$B,C$在$l$上，则____。`,
      type: "fill",
      difficulty: 3,
...
(2) 证明：$\\dfrac1{a_1}+\\dfrac1{a_2}+\\dots+\\dfrac1{a_n}<2$.`,
    ...
    },
    {
      ...
      chapterId: "sequences",
      source: "gaokao",
      prompt: "图1是中国古代建筑中的举架结构，$AA',BB',CC',DD'$是桁，相邻桁的水平距离称为步，垂直距离称为举。图2是某古代建筑屋顶截面的示意图。其中$DD_1,CC_1,BB_1,AA_1$是举，$OD_1,D_1C,CB,BA_1$是相等的步，相邻桁的举步之比分别为$\\dfrac{DD_1}{OD_1}=0.5,\\dfrac{CC_1}{D_1C}=k_1,\\dfrac{BB_1}{CB}=k_2,\\dfrac{AA_1}{BA_1}=k_3$。已知$k_1,k_2,k_3$成公差为$0.1$的等差数列，且直线$OA$的斜率为$0.725$，则$k_3=$____",
      type: "fill",
      difficulty: 2,
...
(2) 设$f(x)=a_1x+a_2x^2+\\dots+a_mx^m$，求$f'(-2)$.`,
    ...
    },
    {
      ...
      chapterId: "sequences",
      source: "gaokao",
      prompt: "记$S_n$为等差数列$\\{a_n\\}$的前$n$项和，若$S_3=6$，$S_5=-5$，则$S_6=$____",
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "sequences",
      source: "gaokao",
      prompt: `记$S_n$为等比数列$\\{a_n\\}$的前$n$项和，$q$为$\\{a_n\\}$的公比，$q>0$，若$S_3=7$，$a_5=1$，则____`,
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "sequences",
      source: "gaokao",
      prompt: `一百零八塔位于宁夏回族自治区青铜峡市，以其独特的建筑格局和深远的历史文化闻名遐迩，该塔群共有108座塔，依山势自上而下排成12行，将第$i$行中塔的座数记为$a_i\\ (i=1,2,\\dots,12)$，其中$a_1=1$，$a_3=a_4=3$，$a_6=a_7=5$，且$a_1,a_2,\\dots,a_{12}$是一个首项为7，公差为2的等差数列，将$a_1,a_2,\\dots,a_{12}$分为6组，每组2个数，使得每组的2个数之和可构成一个项数为6且公差为$d(d>0)$的等差数列，则$d=$____。`,
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "sequences",
      source: "gaokao",
      prompt: `等比数列$\\{a_n\\}$的公比$q\\neq1$，$a_1>0$，$2a_3=a_2+a_1$，记前$n$项和为$S_n$，则____。`,
      type: "fill",
      difficulty: 2,
  ...
  "derivatives": [
    ...
    },
    {
      ...
      chapterId: "derivatives",
      source: "gaokao",
      prompt: `已知函数$f(x)$及其导函数$f'(x)$的定义域均为$\\mathbb{R}$，记$g(x)=f'(x)$，若$f(\\dfrac32-2x),g(2+x)$均为偶函数，则____`,
      type: "fill",
      difficulty: 3,
...
(2) 证明：当$a>0$时，$f(x)>2\\ln a+\\dfrac32$.`,
    ...
    },
    {
      ...
      chapterId: "derivatives",
      source: "gaokao",
      prompt: `设函数$f(x)=(x-1)^2(x-4)$，则____`,
      type: "fill",
      difficulty: 2,
...
(3) 若$f(x)>-2$当且仅当$1<x<2$，求$b$的取值范围.`,
    ...
    },
    {
      ...
      chapterId: "derivatives",
      source: "gaokao",
      prompt: "设函数$f(x)=(x+a)\\ln(x+b)$，若$f(x)\\ge0$，则$a^2+b^2$的最小值为____",
      type: "fill",
      difficulty: 3,
    ...
    },
    {
      ...
      chapterId: "derivatives",
      source: "gaokao",
      prompt: `设函数$f(x)=2x^3-3ax^2+1$，则____`,
      type: "fill",
      difficulty: 3,
...
(ii) 比较$2x_1$与$x_2$的大小，并证明你的结论.`,
    ...
    },
    {
      ...
      chapterId: "derivatives",
      source: "gaokao",
      prompt: `曲线$y=5x+8\\ln x$在点$(1,5)$的切线方程为____。`,
      type: "fill",
      difficulty: 1,
...
(3) 当$x>0$时，$f(x+k)+f(k-x)>2f(k)$，求$k$的最小值.`,
  ...
  "counting": [
    ...
    },
    {
      ...
      chapterId: "counting",
      source: "gaokao",
      prompt: "有甲、乙、丙、丁、戊5名同学站成一排参加文艺汇演，若甲不站在两端，丙和丁相邻，则不同排列方式共有____",
      type: "fill",
      difficulty: 2,
    ...
    },
    {
      ...
      chapterId: "counting",
      source: "gaokao",
      prompt: `甲、乙、丙、丁等8人分成$A,B$两个技术小组，要求每组4人，且甲乙必须在同一组，丙丁不能在同一组，共有多少分配方案____。`,
      type: "fill",
      difficulty: 2,
...
所以E(Y)=∑_{i=1}^n [1/3+(1/6)×(0.4)^{i-1}] = n/3 + (1/6)×∑_{i=0}^{n-1} (0.4)^i = n/3 + (1/6)×(1-0.4^n)/(1-0.4) = n/3 + (1/6)×(1-0.4^n)/0.6 = n/3 + (5/18)×(1-0.4^n)。`,
    ...
    },
    {
      ...
      chapterId: "random-vars",
      source: "gaokao",
      prompt: `为了解推动出口后的亩收入（单位：万元）情况，从该种植区抽取样本，得到推动出口后亩收入的样本均值$\\bar{x}=2.1$，样本方差$s^2=0.01$，已知该种植区以往的亩收入$X$服从正态分布$N(1.8,0.1^2)$，假设推动出口后的亩收入$Y$服从正态分布$N(\\bar{x},s^2)$，则____（若随机变量$Z$服从正态分布$N(\\mu,\\sigma^2)$，$P(Z<\\mu+\\sigma)\\approx0.8413$）`,
      type: "fill",
      difficulty: 2,
...
通过递推可得$d_{2m+1} < d_{2m} < d_{2m+2}$。具体证明略。`,
    ...
    },
    {
      ...
      chapterId: "random-vars",
      source: "gaokao",
      prompt: `设$U=\\{(x_1,x_2,x_3)\\mid x_i\\in\\{-2,-1,1,2\\},i=1,2,3\\}$为空间中64个点构成的集合，记$P(1,1,1)$，记样本空间$\\Omega=\\complement_UP$，从$\\Omega$中随机取一个点，定义随机变量$X$如下：对$\\Omega$中的每个点$A(x_1,x_2,x_3)$，令$X(A)=x_1+x_2+x_3$，则$X$的数学期望为____。`,
      type: "fill",
      difficulty: 3,
